      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          <div className="mt-3 flex flex-wrap gap-1.5">
            {manga.genres.slice(0, variant === 'featured' ? 4 : 2).map((genre) => (
              <Badge 
                key={genre} 
                variant="outline" 
          ...
          <div className="mt-3 flex items-center justify-between text-sm text-muted-foreground">
            <div className="flex items-center gap-1.5">
              ...
              <span className="font-medium">{manga.chapters.length} Chapters</span>
            </div>
            {variant !== 'featured' && (
